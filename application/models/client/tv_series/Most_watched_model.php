...
class Most_watched_model extends CI_Model
{
  ...
  private $_order = array('tvs.content_id' => 'asc');
  ...
  public function getAll($limit = 5, $start = 0)
  {
    ...
    $this->db->from($this->_table . ' tvs');
    $this->db->join($this->_table_reviews . ' r', 'r.content_id=tvs.content_id', 'left');
    $this->db->where('tvs.content_type', 'series');
    $this->db->or_where('tvs.content_type', 'tv_show');
