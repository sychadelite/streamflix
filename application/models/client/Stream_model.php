...
class Stream_model extends CI_Model
{
  ...
  private $_order = array('s.content_id' => 'asc');
  ...
  public function getAll($limit = 5, $start = 0)
  {
    ...
    $this->db->join($this->_table_reviews . ' r', 'r.content_id=s.content_id', 'left');
